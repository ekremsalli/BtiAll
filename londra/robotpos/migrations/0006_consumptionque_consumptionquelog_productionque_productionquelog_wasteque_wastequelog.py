# Generated by Django 3.2.12 on 2023-04-03 17:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('robotpos', '0005_salesque_salesquelog'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('robotpos', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='robotpos.robotpos')),
                ('sales', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='robotpos.salesque')),
            ],
            options={
                'abstract': False,
