...
FIRMS = {
    'default': {
        ...
        'SETTINGS': {
            ...
            'DEFAULT_REVENUE': {
                'ARP_CODE': '181.20.0001',
                'GL_CODE': '181.20.0001',
                'TYPE': 70,
                'NOTES1': 'ŞUBE GELİR',
                'NUMBER': '~',
                'DATAOBJECTPARAMETER': {
                    'FillAccCodesPnPreSave': True
                }
            },
            'DEFAULT_REVENUE_LINE': {
            },
            'DEFAULT_SALES': {
                'TYPE': 20,
            },
...
ROBOTPOS_URL = 'http://10.0.215.56/ingiltere/api/'
ROBOTPOS_TIMEOUT = 30
ROBOTPOS_BRANCHES = [506]
