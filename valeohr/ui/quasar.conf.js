...
module.exports = function (ctx) {
  return {
    //is_dev: process.env.DEV,
      is_dev: true, //server false
     //api_url: 'https://10.5.165.82:8000', //test ortamı
    //api_url: process.env.DEV ? 'http://127.0.0.1:8000' : 'http://192.168.10.70:8000',
    // api_url:'https://10.5.165.251:8000',//prod
